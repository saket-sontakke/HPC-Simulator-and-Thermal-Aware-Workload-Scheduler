"""
===============================================================================
Script Name: 08_single_gpu_categorize_labelled_jobs.py
Description: Categorizes mixed single-gpu CSV files into subfolders 
...
def main():
    ...
    input_csv_dir = data_dir / "labelled_jobs_single_gpu_csv"
    ...
    if GENERATES_FILES:
        ...
        if CREATE_DATA_SYMLINK:
            actual_output_dir = data_dir / "labelled_jobs_single_gpu_csv_categorized"
            actual_output_dir.mkdir(parents=True, exist_ok=True)
            
            # Create shortcut in the log directory
            shortcut_path = log_dir / "labelled_jobs_single_gpu_csv_categorized_shortcut"
