"""
===============================================================================
Script Name: 01_detect_gpu_throttling.py
Description: Scans Parquet files for GPU throttling events based on temperature,
             power, and clock speed limits. Intended to be executed on raw data,
             as the cleaned dataset will not contain clock speed column.
===============================================================================
"""
